"""
Cookie login and credential validation for Music Assistant providers.

Interactive QR and Device Flow presentation belongs to each provider, which
calls :class:`ya_passport_auth.PassportClient` directly.
"""
